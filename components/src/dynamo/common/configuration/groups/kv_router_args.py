...
class KvRouterArgGroup(ArgGroup):
    ...
    def add_arguments(self, parser) -> None:
        ...
        add_argument(
            ...
            default=None,
            help=(
                "KV Router: maximum scheduler-queued requests per eligible worker "
                "before rejecting new requests."
            ),
            arg_type=int,
        )
        add_argument(
            ...
            default=None,
            help=(
                "KV Router: maximum time in milliseconds a request may wait in "
                "the scheduler queue before being failed."
            ),
            arg_type=int,
        )
        add_argument(
