...
impl NvCreateChatCompletionRequest {
    ...
    pub fn response_generator(&self, request_id: String) -> DeltaGenerator {
        ...
        let options = DeltaGeneratorOptions {
            ...
            structured_json_guard: self.uses_pure_json_structured_output(),
            expected_choices: self.inner.n.unwrap_or(1).max(1) as u32,
...
pub struct DeltaGenerator {
    ...
    /// Per-choice text buffered for pure structured JSON streaming.
    structured_json_buffers: HashMap<u32, String>,
    /// Choices whose first complete JSON value has already been emitted.
