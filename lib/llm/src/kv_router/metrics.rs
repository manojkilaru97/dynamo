...
pub struct RouterQueueMetricHandles {
    ...
    pub queue_wait_timeouts: IntCounter,
}
...
impl RouterQueueMetrics {
    pub fn handles(
        ...
        RouterQueueMetricHandles {
            ...
            queue_full_rejections: rejection("queue_full"),
            queue_wait_timeouts: rejection("queue_wait_timeout"),
        }
    }
}
...
dynamo_frontend_router_queue_backpressure_total{model=\"model\",policy_class=\"default\",reason=\"queue_full\",worker_type=\"decode\"} 0
dynamo_frontend_router_queue_backpressure_total{model=\"model\",policy_class=\"default\",reason=\"queue_wait_timeout\",worker_type=\"decode\"} 0
